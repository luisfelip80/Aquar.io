...
void runChat() {
  ...
  while (1) {
    ...
    if(ch=='w'){
      ...
      int ret = sendMsgToServer((void *)&move,sizeof(data));
...
int main() 
{
    ...
    if (!windowInit(LARGURA, ALTURA, "Aquar.io"))
        return -1;
...
void printLoginScreen(char str[])
{
    ...
    al_draw_text(start, al_map_rgb(255, 255, 255), WIDTH / 2, 30, ALLEGRO_ALIGN_CENTRE, "Digite o nome desejado: ");
